...
public class UserService {
	...
	public void verifyEmail(Token token) {
        ...
        if(dbToken==null){
            if(userJpaRepository.findByUsername(token.getUsername())==null) throw new UserException("UnRegistered");
	...
	public void changePassword(PasswordResetResource passwordresetResource) {
		...
		ApplicationUser user= userJpaRepository.findByUsernameAndPassword(passwordresetResource.getUsername(),passwordresetResource.getPassword());
			if(user!=null) {
			BCryptPasswordEncoder bCryptPasswordEncoder = new BCryptPasswordEncoder();
